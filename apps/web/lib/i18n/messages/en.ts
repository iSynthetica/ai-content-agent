...
export const en: Record<string, string> = {
  ...
  "Пресети конфігурації": "Configuration presets",
  "Застосувати пресет": "Apply preset",
  "Застосувати пресет…": "Apply a preset…",
  "Немає збережених пресетів": "No saved presets",
  "Зберегти поточне": "Save current",
  ...
  // BYO-app: креди власного OAuth-застосунку орендаря
  "URL перенаправлення": "Redirect URL",
  "Client ID застосунку": "App Client ID",
  "Client Secret застосунку": "App Client Secret",
  "Зберегти ключі застосунку": "Save app keys",
  "змінити ключі застосунку": "change app keys",
  "Ключі застосунку збережено": "App keys saved",
  "Не вдалося зберегти ключі застосунку": "Couldn't save app keys",
  "Спершу введіть ключі застосунку": "Enter the app keys first",
